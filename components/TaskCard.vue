<template>
    <NuxtLink :to='`tasks/${task.id}`' class="flex items-center text-gray-600 justify-between py-3 border-b-2 border-gray-100 hover:bg-gray-50">
        ...
        <svg width="20" height="20" fill="currentColor" :class="[task.completed ? 'text-green-500 mx-4' : 'mx-4 text-gray-400 dark:text-gray-300']" viewBox="0 0 1024 1024">
